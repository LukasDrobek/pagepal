...
const Page = () => {
  ...
  const test = pricingItems.map(({ plan, tagline, quota, features }) => {
    const price =
    ...
    return (
      ...
      >
        ...
        <div className="p-5">
          ...
          {/* <p className="mt-5 font-display text-6xl font-semibold">${price}</p>
          <p className="text-gray-500">per month</p> */}
          <div className="flex items-end justify-center gap-2.5 mt-5">
            <div className="font-display text-6xl font-semibold">${price}</div>{" "}
    ...
    <>
      <MaxWidthWrapper className="mb-8 mt-24 text-center max-w-5xl">
        ...
        <div className="pt-12 grid grid-cols-1 gap-10 lg:grid-cols-2">
          <TooltipProvider>{test}</TooltipProvider>
        </div>
      </MaxWidthWrapper>
    </>
  );

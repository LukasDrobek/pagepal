    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="bg-white" align="end">
        ...
        <DropdownMenuItem asChild>
          <Link href="/dashboard">
            <FilePieChart className="h-6 w-6 mr-2 pr-2 text-zinc-500 border-r-2 border-zinc-300" />{" "}
            Dashboard
          </Link>
        </DropdownMenuItem>
        ...
        <DropdownMenuItem asChild>
          <Link href="/settings">
            <Settings className="h-6 w-6 mr-2 pr-2 text-zinc-500 border-r-2 border-zinc-300" />{" "}
            Settings
          </Link>
        </DropdownMenuItem>
